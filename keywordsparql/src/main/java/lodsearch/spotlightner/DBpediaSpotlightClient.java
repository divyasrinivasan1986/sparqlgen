...
public class DBpediaSpotlightClient extends AnnotationClient {
    ...
    private final static String API_URL = "http://spotlight.dbpedia.org:80/";
	...
	public List<DBpediaResource> extract(Text text) throws AnnotationException {
		...
		try {
			GetMethod getMethod = new GetMethod("https://api.dbpedia-spotlight.org/annotate/" +
...
//        File output = new File("/home/pablo/eval/wikify/systems/Spotlight.list");
        ...
        List<DBpediaResource> response = c.extract(new Text("actors born in china"));
